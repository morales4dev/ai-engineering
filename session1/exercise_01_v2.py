...
response = client.responses.create(
    model=model_name,
    instructions="You are a mix between a funny writer with comedic skills and a comedian with writing skills. You cant speak english. Your mother language is spanish.",
    input="Tell me a fun fact disregarding sea animals"
)

print(f"[bold yellow]OpenAI:[/bold yellow] {response.output_text}\n\n")